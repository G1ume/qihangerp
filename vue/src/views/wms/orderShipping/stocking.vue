<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="药品ID" prop="goodsId">
        <el-input
          ...
          placeholder="请输入erp系统药品id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="药品编码" prop="goodsNum">
        <el-input
    ...
    <el-table v-loading="loading" :data="shippingList" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="erp系统药品id" align="center" prop="goodsId" />
      <el-table-column label="erp系统药品规格id" align="center" prop="specId" />
      <el-table-column label="药品标题" align="center" prop="goodsTitle" />
      <el-table-column label="药品图片" align="center" prop="goodsImg" />
      <el-table-column label="药品编码" align="center" prop="goodsNum" />
      <el-table-column label="药品规格" align="center" prop="goodsSpec" />
      <el-table-column label="药品规格编码" align="center" prop="specNum" /> -->
...
<!--      </el-table-column>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px" inline>
        ...
        <el-divider content-position="center" v-if="isGen">拣货药品</el-divider>
        <el-table :data="skuList" :row-class-name="rowItemIndex" ref="skuItem">
<!--          <el-table-column type="selection" width="50" align="center" />-->
          <el-table-column label="序号" align="center" prop="index" width="50"/>
          <el-table-column label="药品图片" prop="goodsImg" >
            <template slot-scope="scope">
              <el-image style="width: 70px; height: 70px" :src="scope.row.goodsImg"></el-image>
            </template>
          </el-table-column>
          <el-table-column label="药品标题" prop="goodsTitle" ></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        goodsId: [
          { required: true, message: "erp系统药品id不能为空", trigger: "blur" }
        ],
        specId: [
          { required: true, message: "erp系统药品规格id不能为空", trigger: "blur" }
        ],
        quantity: [
  ...
  methods: {
    ...
    handleSelection(row,isGen) {
      ...
      if(!ids && ids.length===0){
        this.$modal.msgError("请选选择要备货的药品");
        return
      }
