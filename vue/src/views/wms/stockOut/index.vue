...
<!--      <el-table-column label="是否删除0未删除1已删除" align="center" prop="isDelete" />-->
      <el-table-column label="药品数" align="center" prop="goodsUnit" />
      <el-table-column label="药品规格数" align="center" prop="specUnit" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="1000px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-descriptions title="出库单详情">
          ...
          <el-descriptions-item label="药品数">{{form.goodsUnit}}</el-descriptions-item>
...
<!--          </el-descriptions-item>-->
        ...
        <el-divider content-position="center">出库药品明细</el-divider>
...
<!--          <el-table-column type="selection" width="50" align="center" />-->
          ...
          <el-table-column label="药品图片" prop="colorImage" >
            <template slot-scope="scope">
