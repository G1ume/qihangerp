...
<!--      <el-table-column type="selection" width="55" align="center" />-->
      ...
      <el-table-column label="药品数" align="center" prop="sourceGoodsUnit" />
      <el-table-column label="药品规格数" align="center" prop="sourceSpecUnit" />
...
<!--      <el-table-column label="操作入库人id" align="center" prop="stockInOperatorId" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="1000px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px" inline>
        ...
        <el-descriptions title="药品统计">
          <el-descriptions-item label="药品数"> {{ form.sourceGoodsUnit }}</el-descriptions-item>
          <el-descriptions-item label="药品规格数"> {{ form.sourceSpecUnit }}</el-descriptions-item>
...
<!--          <el-table-column type="selection" width="50" align="center" />-->
          ...
          <el-table-column label="药品图片" width="80">
            <template slot-scope="scope">
              <el-image style="width: 70px; height: 70px" :src="scope.row.colorImage"></el-image>
            </template>
          </el-table-column>
          <el-table-column label="药品标题" prop="goodsName" ></el-table-column>
