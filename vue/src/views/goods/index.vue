<template>
 ...
 <!--      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="药品图片" align="center" prop="image" width="100">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="药品图片地址" prop="image">
          <image-upload v-model="form.image"/>
        </el-form-item>
        <el-form-item label="药品编号" prop="number">
          <el-input v-model="form.number" placeholder="请输入药品编号" />
        </el-form-item>
        <el-form-item label="单位名称" prop="unitName">
          <el-input v-model="form.unitName" placeholder="请输入单位名称" />
        </el-form-item>
        <el-form-item label="药品分类ID" prop="categoryId">
          <el-input v-model="form.categoryId" placeholder="请输入药品分类ID" />
        </el-form-item>
        <el-form-item label="条码" prop="barCode">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除药品管理编号为"' + ids + '"的数据项？').then(function() {
        return delGoods(ids);
      }).then(() => {
        this.getList();
