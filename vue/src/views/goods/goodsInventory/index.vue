<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="药品编码" prop="goodsNumber">
        <el-input
...
<!--      <el-table-column label="主键ID" align="center" prop="id" />-->
      <el-table-column label="药品ID" align="center" prop="goodsId" />
      <el-table-column label="药品编码" align="center" prop="goodsNumber" />
  ...
  data() {
    return {
      ...
      rules: {
        ...
        specId: [
          { required: true, message: "药品规格id不能为空", trigger: "blur" }
        ],
        specNumber: [
