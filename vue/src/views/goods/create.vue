  ...
  <div class="app-container">
    <el-form ref="form" :model="form" :rules="rules" label-width="108px">
        ...
        <el-form-item label="药品图片" prop="image">
           ...
           <el-input v-model="form.image" placeholder="请输入药品图片" />
        </el-form-item>
        <el-form-item label="药品编号" prop="number" >
          <el-input v-model="form.number" placeholder="请输入药品编号" style="width:220px"/>
        </el-form-item>
...
<!--        </el-form-item>-->
       ...
       <!--  <el-form-item label="最低库存" prop="lowQty">
        ...
        <!-- <el-divider content-position="center" style="margin-left: 98px;">药品信息</el-divider> -->
...
<!--          </el-table-column>-->
      ...
      <div slot="footer" class="dialog-footer" style="margin-left: 108px;margin-top:20px;margin-bottom: 50px;">
        <el-button type="primary" @click="submitForm">添加药品</el-button>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        name: [{ required: true, message: '药品名不能为空' }],
        image: [{ required: true, message: '药品图片不能为空' }],
        number: [{ required: true, message: '药品编码不能为空' }],
