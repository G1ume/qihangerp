<template>
  <div class="app-container">
    <el-form :model="form" ref="form" size="small" :rules="rules" :inline="true" label-width="98px">
      ...
      <el-row>
        <el-form-item label="采购药品：" prop="goodsList">
          <el-col :span="24">
            <el-button size="small" @click="addGoodsDialog"> 添加药品</el-button>
          </el-col>
        </el-form-item>
        ...
        <el-col :span="24" style="margin-left: 98px;">
          ...
          <el-table :data="form.goodsList" style="width: 100%">
            ...
            <el-table-column prop="colorImage" label="药品图片">
...
<!--            </el-table-column>-->
    ...
    <!-- 添加采购药品对话框 -->
    <el-dialog title="添加药品" :visible.sync="goodsFormOpen" width="500px" append-to-body :close-on-click-modal="false">
      <el-form ref="goodsForm" :model="goodsForm" :rules="goodsRules" label-width="80px">

        <el-form-item label="药品" v-if="goodsFormAdd">
          <!-- <el-input v-model="goodsForm.goodsSpec" placeholder="请输入sku" /> -->
          <el-select v-model="goodsForm.id" filterable remote reserve-keyword placeholder="搜索药品" style="width: 380px;"
        ...
        <el-form-item label="药品图片" prop="id">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        goodsList: [{ required: true, message: '采购药品不能为空' }],
      },
      ...
      goodsRules: {
        id: [{ required: true, message: '请选择药品' }],
